...
class GPS:
	...
	rospy.Subscriber ('/turret/pose', Pose2D, self.get_turret_pose)
    ...
    def get_turret_pose (self,msg):
	#print(msg)
	self.turret_x = int(msg.x)
	self.turret_y = int(msg.y)
	self.turret_theta = msg.theta
...
class Map:
	...
	THETA = gps.turret_theta
	TRANSFORMATION_J = -gps.turret_y
	TRANSFORMATION_I = -gps.turret_x
...
def loop():
    ...
    rospy.Subscriber ('/ros0xrobot/cmd_vel', Twist, check_vel)
